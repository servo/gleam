...
pub trait Gl : Send + Sync
{
    fn get_type(&self) -> GlType;
    fn buffer_data(&self, target: GLenum, size: GLsizeiptr, data: *const GLvoid, usage: GLenum);
    fn buffer_sub_data(&self, target: GLenum, offset: isize, size: GLsizeiptr, data: *const GLvoid);
...
#[inline]
pub fn buffer_data<T>(gl_: &Arc<Gl>, target: GLenum, data: &[T], usage: GLenum) {
    gl_.buffer_data(target,
...
#[inline]
pub fn buffer_data_raw<T>(gl_: &Arc<Gl>, target: GLenum, data: &T, usage: GLenum) {
    gl_.buffer_data(target,
...
#[inline]
pub fn buffer_sub_data<T>(gl_: &Arc<Gl>, target: GLenum, offset: isize, data: &[T]) {
    gl_.buffer_sub_data(target,
                        offset,
                        (data.len() * size_of::<T>()) as GLsizeiptr,
                        data.as_ptr() as *const GLvoid);
}
